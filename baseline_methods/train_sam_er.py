...
import cv2
import json
# from datasets.vessel_9cls_3task_datasets_with_bbox_with_dataaug_rehearsal import VesselSeqDataset, VesselTestDataset, VesselJointDataset
...
parser.add_argument("-task_name", type=str, default="SAM-ER")
...
parser.add_argument("--rehearsal-rate", type=float, default=0.25)
...
if args.dataset == "vessel_3task":
    from datasets.vessel_9cls_3task_datasets_with_bbox_with_dataaug_rehearsal import VesselSeqDataset, VesselTestDataset
    args.task_num = 3
elif args.dataset == "vessel_5task":
    from datasets.vessel_9cls_5task_datasets_with_bbox_with_dataaug_rehearsal import VesselSeqDataset, VesselTestDataset
    args.task_num = 5
elif args.dataset == "prostate":
    from datasets.prostate_6task_datasets_with_bbox_with_dataaug_rehearsal import VesselSeqDataset, VesselTestDataset
    args.task_num = 6
...
def main():
    ...
    for task in range(args.task_num):
        ...
        losses = []
        best_loss = 1e10
        train_dataset = VesselSeqDataset(args.tr_npy_path, order_idx=args.order, rehearsal_rate=args.rehearsal_rate)
