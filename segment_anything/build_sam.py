...
def build_sam_vit_h(checkpoint=None,
    ...
    return _build_sam(
        ...
        ############################ lora ############################
        iencoder_use_lora=iencoder_use_lora,
        iencoder_lora_config=iencoder_lora_config,
        decoder_use_lora=decoder_use_lora,
...
def _build_sam(
    ...
    sam = Sam(
        image_encoder=ImageEncoderViT(
            ...
            ############################ lora ############################
            use_lora=iencoder_use_lora,
            lora_config=iencoder_lora_config,
            ##############################################################
        ),
